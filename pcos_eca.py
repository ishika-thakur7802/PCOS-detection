...
# Train the model
history = model.fit(x_train, y_train, epochs=51, batch_size=16, validation_data=(x_val, y_val),callbacks=[early_stopping, checkpoint], verbose=1)
model.save('/content/drive/MyDrive/PCOS-Hack/PCOSGen-test')
